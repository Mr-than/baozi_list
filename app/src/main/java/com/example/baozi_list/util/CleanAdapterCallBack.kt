...
class CleanAdapterCallBack(private val oldList:()->List<Clean>, private val newList:()->List<Clean>): DiffUtil.Callback() {
    ...
    override fun areContentsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
        ...
        return (oldDataList[oldItemPosition].date == newDataList[newItemPosition].date &&
                oldDataList[oldItemPosition].carNumber==newDataList[newItemPosition].carNumber &&
                oldDataList[oldItemPosition].laneNumber==newDataList[newItemPosition].laneNumber &&
                oldDataList[oldItemPosition].multiData==newDataList[newItemPosition].multiData &&
